    ...
    <FadeIn delay={index * 0.05}>
      ...
      >
        <div className="flex items-start gap-4 mb-4">
          ...
          <h2 className="text-xl font-bold text-[var(--text-primary)] leading-snug pt-0.5">
            {section.title}
          </h2>
        </div>
        {section.leadBefore && (
        ...
        {section.lead && <p className="text-sm text-[var(--text-muted)] leading-relaxed mb-5">{section.lead}</p>}
        ...
        {section.footer && (
          <p className="text-sm text-[var(--text-dim)] leading-relaxed border-t pt-4 mt-2" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
            {section.footer}
          </p>
        )}
      </article>
...
export default function WhyVendors() {
  ...
  return (
    <main className="min-w-0 overflow-x-hidden">
      <section
        ref={heroRef}
        className="relative pt-[calc(6rem+env(safe-area-inset-top,0px))] pb-20 md:pb-24 overflow-hidden"
      >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative z-10">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-[1.05] tracking-tight mb-6"
          >
          ...
          <motion.p
            ...
            className="text-[var(--text-muted)] text-base md:text-lg leading-relaxed max-w-2xl mx-auto mb-4"
          >
            Most bullion businesses already have their own app, customer base, and sales process. So the natural question
            is: why join Cridora at all?
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.48, duration: 0.65 }}
            className="text-[var(--text-soft)] text-base md:text-lg leading-relaxed max-w-2xl mx-auto mb-10 font-medium"
          >
      ...
      <section className="py-16 md:py-24 relative" style={{ background: 'var(--section-wash-a)' }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 flex flex-col gap-10">
          ...
          <FadeIn>
            ...
            >
              <h2 className="text-xl font-bold text-[var(--text-primary)] mb-4">Why This Matters</h2>
              ...
              <p className="text-lg md:text-xl font-semibold gradient-gold-text leading-snug text-center md:text-left">
          ...
          <FadeIn>
            ...
            >
              ...
              <p className="text-sm text-[var(--text-primary)] leading-relaxed font-semibold pt-2 border-t" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
