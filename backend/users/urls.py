...
from .vendor_settlement import (
    ...
    AdminVendorPayoutProofUpdateView,
...
urlpatterns = [
    ...
    path('admin/catalog-products/', AdminCatalogProductsView.as_view(), name='admin-catalog-products'),
    ...
    path('admin/bank-payouts/<int:payout_id>/proof/', AdminVendorPayoutProofUpdateView.as_view(), name='admin-bank-payout-proof'),
